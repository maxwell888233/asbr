...
//typedef BeamLaser LaserSensor;
//typedef BeamData  LaserSensorData;
        ...
        first_reconfigure_call_(true)
{
  ...
  private_nh_.param("laser_z_hit", z_hit_, 0.8);
...
AmclNode::laserReceived(const sensor_msgs::LaserScanConstPtr& laser_scan)
{
  ...
  if(lasers_update_[laser_index])
  {
    ...
    //if( dynamic_cast<BeamLaser>( lasers_[laser_index] ) != NULL )
    //pf_update_sensor( pf_, &beam, (AMCLSensorData*)&ldata);
